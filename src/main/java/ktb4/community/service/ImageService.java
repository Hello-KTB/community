...
public class ImageService {
     ...
     */
    public PresignedUrlResponseDto generatePresignedUrl(String originalFilename, String dirName) {
        ...
        // 3. 디렉토리 경로 구분 (profiles/uuid.png 또는 posts/uuid.png)
        ...
        // 6. 서울 리전(ap-northeast-2) 정보가 명시된 S3 최종 객체 조회 URL 생성
